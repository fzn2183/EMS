...
namespace EmployeeManagment.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public async Task<IActionResult> Create( SystemCode systemCode)
        {
            ...
            {
                systemCode.CreatedById = "Faizaan";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Descrption,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    systemCode.ModifiedById = "Faizaan";
